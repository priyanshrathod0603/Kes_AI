...
INSERT INTO "new_Document" ("chapterId", "createdAt", "extractedText", "fileName", "filePath", "fileSize", "fileType", "id", "processed", "schoolClassId", "subjectId", "title", "topicId", "updatedAt") SELECT "chapterId", "createdAt", "extractedText", "fileName", "filePath", "fileSize", "fileType", "id", "processed", "schoolClassId", "subjectId", "title", "topicId", "updatedAt" FROM "Document";
DROP TABLE "Document";
